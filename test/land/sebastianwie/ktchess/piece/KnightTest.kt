...
internal class KnightTest {
    ...
    fun setUp() {
        board = Board()
        knight = Knight(Player.BLACK, board)
    }
    ...
    fun testGetMoves() {
        ...
        assertEquals(expectation, board.show(knight.getMoves()))
    }
